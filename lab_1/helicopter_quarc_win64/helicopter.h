...
extern void helicopter_output0(void);
extern void helicopter_update0(void);
extern void helicopter_output(int_T tid);
extern void helicopter_update(int_T tid);
 ...
 * '<S5>'   : 'helicopter/Joystick'
 * '<S6>'   : 'helicopter/Pitch controller'
 * '<S7>'   : 'helicopter/Elevation controller/If Action Subsystem'
