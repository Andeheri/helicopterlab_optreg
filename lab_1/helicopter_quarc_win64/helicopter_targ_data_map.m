  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% helicopter_P.DeadZonex_Start
	  section.data(19).logicalSrcIdx = 28;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_P.DeadZonex_End
	  section.data(20).logicalSrcIdx = 29;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_P.Gainx_Gain
	  ...
	  ;% helicopter_P.DeadZoney_Start
	  section.data(47).logicalSrcIdx = 56;
	  section.data(47).dtTransOffset = 46;
	
	  ;% helicopter_P.DeadZoney_End
	  section.data(48).logicalSrcIdx = 57;
	  section.data(48).dtTransOffset = 47;
	
	  ;% helicopter_P.Gainy_Gain
	  ...
	  ;% helicopter_P.GameController_BufferSize
	  ...
	  ;% helicopter_P.GameController_AutoCenter
	  section.data(38).logicalSrcIdx = 120;
	  section.data(38).dtTransOffset = 37;
	
	  ;% helicopter_P.GameController_Enabled
	  ...
	  ;% helicopter_P.GameController_ControllerNumber
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% helicopter_B.RateTransitionx
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_B.Joystick_gain_x
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	  ...
	  ;% helicopter_B.RateTransitiony
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_B.Joystick_gain_y
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.XScope_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 28;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_DW.YScope_PWORK.LoggedData
  ...
  targMap.checksum0 = 3936747614;
  targMap.checksum1 = 3606900887;
  targMap.checksum2 = 748190067;
  targMap.checksum3 = 2387718013;
