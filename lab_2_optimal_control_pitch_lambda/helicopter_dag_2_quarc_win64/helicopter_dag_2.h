...
#ifndef RTW_HEADER_helicopter_dag_2_h_
#define RTW_HEADER_helicopter_dag_2_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter_dag_2_COMMON_INCLUDES_
#define helicopter_dag_2_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* helicopter_dag_2_COMMON_INCLUDES_ */

#include "helicopter_dag_2_types.h"
...
#define helicopter_dag_2_rtModel       RT_MODEL_helicopter_dag_2_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } lambdavsp_c_PWORK;                 /* '<Root>/lambda vs p_c' */
...
#define rtB                            helicopter_dag_2_B
#define BlockIO                        B_helicopter_dag_2_T
#define rtX                            helicopter_dag_2_X
#define ContinuousStates               X_helicopter_dag_2_T
#define rtXdot                         helicopter_dag_2_XDot
#define StateDerivatives               XDot_helicopter_dag_2_T
#define tXdis                          helicopter_dag_2_XDis
#define StateDisabled                  XDis_helicopter_dag_2_T
#define rtP                            helicopter_dag_2_P
#define Parameters                     P_helicopter_dag_2_T
#define rtDWork                        helicopter_dag_2_DW
#define D_Work                         DW_helicopter_dag_2_T

/* Parameters (default storage) */
struct P_helicopter_dag_2_T_ {
  ...
  real_T Gainy_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Joystick_gain_y_Gain;         /* Expression: -1
  ...
  real_T Gainx_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Joystick_gain_x_Gain;         /* Expression: -1
...
struct tag_RTM_helicopter_dag_2_T {
  const char_T *path;
...
extern P_helicopter_dag_2_T helicopter_dag_2_P;

/* Block signals (default storage) */
extern B_helicopter_dag_2_T helicopter_dag_2_B;

/* Continuous states (default storage) */
extern X_helicopter_dag_2_T helicopter_dag_2_X;

/* Block states (default storage) */
extern DW_helicopter_dag_2_T helicopter_dag_2_DW;
...
extern void helicopter_dag_2_initialize(void);
extern void helicopter_dag_2_output0(void);
extern void helicopter_dag_2_update0(void);
extern void helicopter_dag_2_output(int_T tid);
extern void helicopter_dag_2_update(int_T tid);
extern void helicopter_dag_2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_dag_2_rtModel *helicopter_dag_2(void);
...
extern RT_MODEL_helicopter_dag_2_T *const helicopter_dag_2_M;
 ...
 *
 * '<Root>' : 'helicopter_dag_2'
 * '<S1>'   : 'helicopter_dag_2/Conversion'
 * '<S2>'   : 'helicopter_dag_2/Degrees to Radians'
 * '<S3>'   : 'helicopter_dag_2/Elevation controller'
 * '<S4>'   : 'helicopter_dag_2/Helicopter_interface'
 * '<S5>'   : 'helicopter_dag_2/Joystick'
 * '<S6>'   : 'helicopter_dag_2/Pitch controller'
 * '<S7>'   : 'helicopter_dag_2/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'helicopter_dag_2/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter_dag_2/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter_dag_2/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter_dag_2/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter_dag_2/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter_dag_2/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter_dag_2/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_dag_2_h_ */
