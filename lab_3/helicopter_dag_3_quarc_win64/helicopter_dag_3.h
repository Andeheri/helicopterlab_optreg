...
#endif                                 /* helicopter_dag_3_COMMON_INCLUDES_ */

#include "helicopter_dag_3_types.h"
...
#define helicopter_dag_3_rtModel       RT_MODEL_helicopter_dag_3_T
...
#define rtB                            helicopter_dag_3_B
#define BlockIO                        B_helicopter_dag_3_T
#define rtX                            helicopter_dag_3_X
#define ContinuousStates               X_helicopter_dag_3_T
#define rtXdot                         helicopter_dag_3_XDot
#define StateDerivatives               XDot_helicopter_dag_3_T
#define tXdis                          helicopter_dag_3_XDis
#define StateDisabled                  XDis_helicopter_dag_3_T
#define rtP                            helicopter_dag_3_P
#define Parameters                     P_helicopter_dag_3_T
#define rtDWork                        helicopter_dag_3_DW
#define D_Work                         DW_helicopter_dag_3_T

/* Parameters (default storage) */
struct P_helicopter_dag_3_T_ {
...
struct tag_RTM_helicopter_dag_3_T {
  const char_T *path;
...
extern P_helicopter_dag_3_T helicopter_dag_3_P;

/* Block signals (default storage) */
extern B_helicopter_dag_3_T helicopter_dag_3_B;

/* Continuous states (default storage) */
extern X_helicopter_dag_3_T helicopter_dag_3_X;

/* Block states (default storage) */
extern DW_helicopter_dag_3_T helicopter_dag_3_DW;

/* Model entry point functions */
extern void helicopter_dag_3_initialize(void);
extern void helicopter_dag_3_output(void);
extern void helicopter_dag_3_update(void);
extern void helicopter_dag_3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_dag_3_rtModel *helicopter_dag_3(void);
...
extern RT_MODEL_helicopter_dag_3_T *const helicopter_dag_3_M;
 ...
 *
 * '<Root>' : 'helicopter_dag_3'
 * '<S1>'   : 'helicopter_dag_3/Conversion'
 * '<S2>'   : 'helicopter_dag_3/Degrees to Radians'
 * '<S3>'   : 'helicopter_dag_3/Elevation controller'
 * '<S4>'   : 'helicopter_dag_3/Helicopter_interface'
 * '<S5>'   : 'helicopter_dag_3/Input regulator'
 * '<S6>'   : 'helicopter_dag_3/Joystick'
 * '<S7>'   : 'helicopter_dag_3/Pitch controller'
 * '<S8>'   : 'helicopter_dag_3/Elevation controller/If Action Subsystem'
 * '<S9>'   : 'helicopter_dag_3/Helicopter_interface/Elevation rad to deg'
 * '<S10>'  : 'helicopter_dag_3/Helicopter_interface/Elevation rate rad to deg'
 * '<S11>'  : 'helicopter_dag_3/Helicopter_interface/Pitch rad to deg'
 * '<S12>'  : 'helicopter_dag_3/Helicopter_interface/Pitch rate rad to deg'
 * '<S13>'  : 'helicopter_dag_3/Helicopter_interface/Pitch rate rad to deg1'
 * '<S14>'  : 'helicopter_dag_3/Helicopter_interface/Travel rad to deg'
 * '<S15>'  : 'helicopter_dag_3/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_dag_3_h_ */
