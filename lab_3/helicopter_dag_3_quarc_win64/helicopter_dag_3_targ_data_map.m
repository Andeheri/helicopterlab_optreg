  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% helicopter_dag_3_P.ul
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 14;
	
	  ;% helicopter_dag_3_P.uu
	  ...
	  ;% helicopter_dag_3_P.Step_Y0
	  section.data(38).logicalSrcIdx = 52;
	  section.data(38).dtTransOffset = 37;
	
	  ;% helicopter_dag_3_P.Step_YFinal
	  section.data(39).logicalSrcIdx = 53;
	  section.data(39).dtTransOffset = 38;
	
	  ;% helicopter_dag_3_P.Constant_Value
	  section.data(40).logicalSrcIdx = 54;
	  section.data(40).dtTransOffset = 39;
	
	  ;% helicopter_dag_3_P.Switch_Threshold
	  section.data(41).logicalSrcIdx = 55;
	  section.data(41).dtTransOffset = 40;
	
	  ;% helicopter_dag_3_P.Gain1_Gain_g
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% helicopter_dag_3_B.Gain1
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 19;
	
	  ;% helicopter_dag_3_B.FromWorkspace_j
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_dag_3_DW.ToFile_PWORK.FilePtr
	  ...
	  ;% helicopter_dag_3_DW.ToFile1_PWORK.FilePtr
	  ...
	  ;% helicopter_dag_3_DW.Scope1_PWORK.LoggedData
	  ...
	  ;% helicopter_dag_3_DW.ToFile_IWORK.Count
	  ...
	  ;% helicopter_dag_3_DW.ToFile1_IWORK.Count
	  section.data(4).logicalSrcIdx = 48;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helicopter_dag_3_DW.FromWorkspace_IWORK_d.PrevIndex
  ...
  targMap.checksum0 = 2436993970;
  targMap.checksum1 = 177235433;
  targMap.checksum2 = 1580888293;
  targMap.checksum3 = 1659806876;
